...
public final class QueryUtils {
    ...
    public static List<ObjectL> extractEarthquakesFromJSON(String earthJSON) {
        ...
        List<ObjectL> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                ObjectL thisEq = new ObjectL(magnitude, location, time, url);
    ...
    public static List<ObjectL> fetchEarthquakeData(String requestUrl) {
        ...
        List<ObjectL> earthquakes = extractEarthquakesFromJSON(jsonResponse);
